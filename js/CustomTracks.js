  ...
  CustomTrack.types = {
    ...
    */
    ...
    bed: {
      ...
      drawArrows: function(ctx, lineY, halfHeight, startX, endX, direction) {
        ...
        for (var i = startX + 2; i < endX - arrowHeight; i += 7) {
        ...
        if (data.thickInt) {
          ...
          if (data.blockInts) {
            ...
            _.each(data.blockInts, function(bInt) {
              ...
              if (thickOverlap) {
                ctx.fillRect(thickOverlap.x, i * lineHeight + 1, thickOverlap.w, lineHeight - lineGap);
              }
            ...
            ctx.fillRect(data.pInt.x, i * lineHeight + halfHeight - quarterHeight + 1, data.pInt.w, quarterHeight * 2 - 1);
        ...
        remote = new RemoteTrack(cache, function(start, end, storeIntervals) {
          ...
          $.ajax(ajaxUrl, {
            ...
            success: function(data) {
              ...
              var intervals = _.map(lines, function(l) { return self.type('bed').parseLine.call(self, l); });
