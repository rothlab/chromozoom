...
// LOADING FUNCTIONS
  ...
  private function loadWithSource($Source) {
    ...
    for ($i = 0; $i < $cnt; $i++) {
      ...
      // HACKFIX: from the YAML spec...
      // > The “-”, “?” and “:” characters used to denote block collection entries are perceived 
      // > by people to be part of the indentation
      // Therefore, when calculating the indent, I am ltrimming these too.
      // Otherwise YAML produced by Ruby 1.8.7's to_yaml (specifically, hashes containing arrays)
      // are mangled when loaded by spyc.
